...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), Max= True):
        ...
        **********************************************************************
        ...
        if Max:
            ...
            for move in legal_moves:
                next_state = game.forecast_move(move)
                child_score, child_move = self.alphabeta(next_state, depth-1, alpha, beta, False)
            ...
            for move in legal_moves:
                next_state = game.forecast_move(move)
                child_score, child_move = self.alphabeta(next_state, depth-1, alpha, beta, True)
